            ...
            <div class="hey">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        ...
                        <ul class="nav flex-column mb-2">
                            <li class="nav-item">
                                <a class="nav-link active" href="registerEmployee.php">
                ...
                <main class="form-signin">
                    <form action="services/authService.php" method="POST">
                        ...
                        <h1 class="h3 mb-3 fw-normal">Register Admin</h1>
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="0912235354"
                                name="phone">
