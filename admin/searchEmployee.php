            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="form-floating mt-4 mb-4">
                    <form class="d-flex" action="searchEmployee.php" method="POST">
                        <input class="form-control me-2" type="search" placeholder="Search by ID" aria-label="Search"
                            value="<?php echo $_POST['searchId'] ?>" name="searchId">
                ...
                <div class="table-responsive">
                  ...
                  include ('../config/db.php');
									...
									$tsql = "select * from hotel.user where user.id = $searchId";
									$tre = mysqli_query($conn,$tsql);
                  $count = mysqli_num_rows($tre);
                  if($count == 0) {
                    echo "<h1> No Result Found </h1>";
                     ...
                     if($_SESSION['user']['role'] == "Manager") {
											echo"<tr>
												...
												<th>".$trow['phone']."</th>
												<th>".$trow['role']."</th>
												<th><a href='delete.php?id=".$trow['id']." ' class='btn btn-primary'>View</a></th>
